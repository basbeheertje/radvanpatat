...
- `scripts/generate-roadmap.mjs`: afgeronde milestones tellen niet meer mee in de limiet van 9 open roadmap-items en blijven altijd zichtbaar zolang ze een due date hebben.
- `src/frontend/components/roadmap-board.js`: de `Nu`-kolom toont standaard de 3 nieuwste afgeronde milestones en kan extra afgeronde milestones uitklappen.
- `tests/roadmap-generator.test.mjs`: regressietests toegevoegd voor zichtbaarheid van afgeronde milestones, de open-work limiet en sortering van afgeronde milestones op due date.
...
- 2026-07-26 (Codex): feat(roadmap): keep completed milestones visible and collapse older completed releases

(function (window, document) {
	...
	const storageInventory = Object.freeze({
		necessary: Object.freeze([
			...
			Object.freeze({
				name: "rad-van-patat-roulette-rads",
				type: "localStorage",
				provider: "Rad van Patat",
				duration: "untilRemoved",
				purpose: "wheelCollection"
			}),
			Object.freeze({
				name: "rad-van-patat-actief-rad",
				type: "localStorage",
				provider: "Rad van Patat",
				duration: "untilRemoved",
				purpose: "activeWheel"
	...
	const copy = Object.freeze({
		nl: Object.freeze({
			...
			purposes: {
				...
				wheelCollection: "Bewaart alle opgeslagen rads en hun itemselecties op dit apparaat.",
		...
		en: Object.freeze({
			...
			purposes: {
				...
				wheelCollection: "Stores every saved wheel and its item selection on this device.",
		...
		es: Object.freeze({
			...
			purposes: {
				...
				wheelCollection: "Guarda todas las ruedas almacenadas y sus selecciones de elementos en este dispositivo.",
		...
		pl: Object.freeze({
			...
			purposes: {
				...
				wheelCollection: "Przechowuje wszystkie zapisane koła i ich zestawy pozycji na tym urządzeniu.",
		...
		de: Object.freeze({
			...
			purposes: {
				...
				wheelCollection: "Speichert alle gesicherten Räder und ihre Elementauswahl auf diesem Gerät.",
